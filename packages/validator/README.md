...
which own the document-key grammar and the text-only value type and are where a
malformed argument is refused. A request never carries a directory to read from,
