...
PROSE_OBLIGATIONS: tuple[ProseObligation, ...] = (
    ...
    ProseObligation(model="FromParamExpression", prose_hash="7c8360b7bd53", descriptive=True),
    ProseObligation(
        model="FromParamExpression", field="from_param",
        rule_ids=("RULE-ENDP-070",),
        prose_hash="68776809d6d5",
    ),
    ProseObligation(model="TemplateFilterLanding", prose_hash="d936a02dd410", descriptive=True),
    ProseObligation(
    ...
    ProseObligation(
        ...
        prose_hash="b9f265507542",
        rule_ids=("RULE-ENDP-080",),
        structural=(
            ...
            "— for either placement, and RULE-ENDP-080 carries the header "
            "placement's own shape, which the annotation cannot because one "
            "field serves both"
        ),
    ),
    ProseObligation(
    ...
    ProseObligation(
        ...
        rule_ids=(
            "RULE-ENDP-002", "RULE-ENDP-055", "RULE-ENDP-070", "RULE-ENDP-071",
            "RULE-ENDP-068",
        ),
