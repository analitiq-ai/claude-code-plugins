...
byte of drift in them. The prose gates in this suite police *hand-authored*
prose outside generated regions, so they skip these files the same way they
mask a `BEGIN GENERATED` block: the content is a rendering of the contract,
not a copy that can rot.
