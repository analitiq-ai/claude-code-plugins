...
* **validator:** stop deciding whether a pipeline may run ([#448](https://github.com/analitiq-ai/claude-code-plugins/issues/448))
* **validator:** type_map_findings(doc, scope=...) no longer accepts scope.
* **validator:** grade packages and workspaces in memory from the published requests ([#439](https://github.com/analitiq-ai/claude-code-plugins/issues/439))
...
* **validator:** grade packages and workspaces in memory from the published requests ([#439](https://github.com/analitiq-ai/claude-code-plugins/issues/439)) ([ee79b2c](https://github.com/analitiq-ai/claude-code-plugins/commit/ee79b2c9ee18c19063a6270fb7b0af5e063525ce))
* **validator:** stop deciding whether a pipeline may run ([#448](https://github.com/analitiq-ai/claude-code-plugins/issues/448)) ([d63c606](https://github.com/analitiq-ai/claude-code-plugins/commit/d63c60620eb259d1ae44a492436f7e521b5c64f8)), closes [#447](https://github.com/analitiq-ai/claude-code-plugins/issues/447)
...
* address Codex review findings on [#303](https://github.com/analitiq-ai/claude-code-plugins/issues/303) ([8d6a205](https://github.com/analitiq-ai/claude-code-plugins/commit/8d6a2059a149bad8f3910c5f32617e3e9fef16dc))
...
* **validator:** report a directory the kernel will not list instead of reading it as empty ([#389](https://github.com/analitiq-ai/claude-code-plugins/issues/389)) ([cd5840a](https://github.com/analitiq-ai/claude-code-plugins/commit/cd5840a8de2bbd48e4f5d242a8637713c210402b))


### Code Refactoring

* **validator:** type_map_findings grades a map by its kind alone ([#444](https://github.com/analitiq-ai/claude-code-plugins/issues/444)) ([5b44973](https://github.com/analitiq-ai/claude-code-plugins/commit/5b449739d301e83dd1690b125bdbdde76e156b5a))
