...
(`RULE-ENDP-043`) instead of restating it; an id that stops resolving fails the
...
all hold: 11 of the 21 below have no validator, so nothing rejects
...
In this file: **10** shape · **2** coherence · **5** reference · **2** process · **2** choice.
