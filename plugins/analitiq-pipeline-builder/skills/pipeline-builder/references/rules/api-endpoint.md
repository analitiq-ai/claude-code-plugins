...
(`RULE-ENDP-020`) instead of restating it; an id that stops resolving fails the
...
all hold: 11 of the 20 below have no validator, so nothing rejects
...
In this file: **10** structural · **3** advisory · **3** referential · **2** procedural · **2** judgment.
