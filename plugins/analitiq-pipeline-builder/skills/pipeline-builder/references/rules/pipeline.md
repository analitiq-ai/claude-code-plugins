...
Covers: every rule this plugin owns that binds a **`pipeline`** document, plus the rules that bind every authored document. If you are authoring one, this file is the whole of what you must satisfy — no other rule file in this set applies to it.

**Satisfy every rule in this file.** A clean validation run is not proof they
all hold: 10 of the 32 below have no validator, so nothing rejects
...
In this file: **14** shape · **5** coherence · **8** reference · **3** process · **2** choice.
