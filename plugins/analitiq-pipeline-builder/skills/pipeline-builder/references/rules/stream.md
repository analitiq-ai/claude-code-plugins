...
all hold: 26 of the 59 below have no validator, so nothing rejects
...
In this file: **15** shape · **15** coherence · **18** reference · **5** process · **6** choice.
...
| RULE-STRM-043 | A stream's connector-scoped endpoint_ref SHOULD name an endpoint the referenced connector actually publishes. | `stream` | warning | validator |
