...
| RULE-STRM-026 | A filter on an API source MUST name a field the referenced endpoint offers filtering on, with an operator that endpoint binds for that field. | `stream` | error | — |
