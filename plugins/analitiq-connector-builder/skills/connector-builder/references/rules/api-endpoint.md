...
| RULE-ENDP-067 | A filter binding that renders its own value MUST interpolate the filter's value, MUST render something around it, and MUST read nothing else from the stream scope. | `api-endpoint` | error | validator |
