...
| RULE-ENDP-048 | An embedded request or response schema MUST be valid against the JSON Schema draft this contract is written in, and neither it nor any node within it MAY declare a different draft. | `api-endpoint` | error | validator | — |
