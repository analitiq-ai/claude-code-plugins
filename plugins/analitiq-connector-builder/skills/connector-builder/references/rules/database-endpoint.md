...
Grades: every rule this plugin owns that binds a **`database-endpoint`** document, plus the rules that bind every authored document. If you are authoring one, this file is the whole of what you must satisfy — no other rule file in this set applies to it.

**Satisfy every rule in this file.** A clean validation run is not proof they
all hold: 14 of the 27 below have no validator, so nothing rejects
...
In this file: **10** shape · **3** coherence · **5** reference · **6** process · **3** choice.
